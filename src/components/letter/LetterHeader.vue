<template>
  <div class="header">
    ...
    <router-link v-if="path ==='/Intro' || path ==='/Completion'" to="/PabloMain" class="symbol">
      <img src="@/assets/images/common/arrow_left@2x.png" alt="메인으로가기">
    </router-link>
    ...
    <div class="flex-box">
      ...
      <!--주제보기-->
      <!-- todo! 이슈id = 0010660 / 주제보기 버튼 노출 필요  -->
      <Alert  v-if="path !=='/Intro' && path !=='/Completion' && (path ==='/Recording' && page !== 'free') || path ==='/Watching' "
        ...
        <button class="btn-right" @click="globalUtils.alert(slotProps,'subject')">
          <span class="img"><img src="@/assets/images/common/ic-drawing@2x.png" alt="주제보기"></span>
