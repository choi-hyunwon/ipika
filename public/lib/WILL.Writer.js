...
*/
		if (WILL.frameID != WILL.canvas.frameID) {
			var callback = (this.tool.type == WILL.Tool.Type.ERASER)?this.erase:this.drawPath;
...
*/
	...
	drawPathPart: function() {
		this.strokeRenderer.draw(this.context.pathPart, this.context.inputPhase == Module.InputPhase.End);
